...
import Foundation/// Custom errors for the NetworkService.
enum NetworkErrorCode: Error, Equatable {
...
class NetworkService {
    ...
    func fetchData<T: Decodable>(
        ...
        guard let httpResponse = response as? HTTPURLResponse, (200...299).contains(httpResponse.statusCode) else {
            throw NetworkErrorCode.invalidResponse
        }
        ...
        do {
            ...
            throw NetworkErrorCode.decodingFailed
        }
    }
}
